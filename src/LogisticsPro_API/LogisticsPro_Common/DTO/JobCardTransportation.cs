...
{
    public class JobCardTransportation
    {
        ...
        public decimal TotalSellPrice
        {
            get
            {
                ...
                return sellBase + sellTax + extra + parking + water + extraTaxAmount+ parkingTaxAmount+ waterTaxAmount;
            }
        }
        ...
        public decimal TotalSellTaxAmount
        {
            get
            {
                ...
                return selltax + extraTaxAmount+ parkingTaxAmount+ waterTaxAmount;
            }
        }
