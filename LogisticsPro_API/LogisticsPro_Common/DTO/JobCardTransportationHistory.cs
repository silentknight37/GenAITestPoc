...
{
    public class JobCardTransportationHistory
    {
        ...
        public bool? IsJobCardClosed { get; set; }
        ...
        public decimal TotalCostPrice
        {
            get
            {
                ...
                return costBase + costTax + extra + parking + water+ extraTaxAmount;
            }
        }
        ...
        public decimal TotalSellPrice
        {
            get
            {
                var sellBase = SellBaseAmount.HasValue ? SellBaseAmount.Value : 0;
                var sellTax = SellTaxAmount.HasValue ? SellTaxAmount.Value : 0;
                ...
                return sellBase + sellTax + extra + parking + water + extraTaxAmount;
            }
        }
